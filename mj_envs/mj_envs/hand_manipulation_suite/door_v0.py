...
class DoorEnvV0(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self, **kwargs):
        ...
        if self.control_mode == 'Torque':
            mujoco_env.MujocoEnv.__init__(self, curr_dir+'/assets/DAPG_door.xml', 5)  # frame_skip = 5, here are define frame_skip.
        elif self.control_mode == 'PID':
            mujoco_env.MujocoEnv.__init__(self, curr_dir+'/assets/DAPG_door.xml', 1)  # frame_skip = 1, here are define frame_skip.
