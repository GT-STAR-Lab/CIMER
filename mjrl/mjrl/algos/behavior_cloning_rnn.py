...
class BC:
    ...
    def compute_transformations(self):
        ...
        if self.expert_paths == [] or self.expert_paths is None:
            ...
            in_shift, in_scale = np.mean(observations, axis=0), np.std(observations, axis=0)  # along the time horizon
    ...
    def mse_loss(self, data, idx=None):
        ...
        print(act_pi) # this should require the grad since it is computed from the model.
        asd
